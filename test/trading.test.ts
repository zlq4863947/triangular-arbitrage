...
const testFetchBalance = async () => {
  ...
  const res = await trading.order.getBalance(exchange);
  console.log(res);
};
...
const testPlaceOrder = async () => {
  ...
  const t2 =
    '{"id":"BTC-ETH-SALT","a":{"coinFrom":"BTC","coinTo":"ETH","pair":"ETH/BTC","side":"buy","conversionRate":0.078563,"price":0.078563,"quantity":1.67},"b":{"coinFrom":"ETH","coinTo":"SALT","pair":"SALT/ETH","side":"buy","conversionRate":0.004515,"price":0.004515,"quantity":0.01},"c":{"coinFrom":"SALT","coinTo":"BTC","pair":"SALT/BTC","side":"sell","price":0.000355,"quantity":100.75,"conversionRate":2816.9014084507044},"rate":0.08120815,"ts":1520659933180}';
  const t3 =
    '{"id":"BTC-BNB-ZIL","a":{"coinFrom":"BTC","coinTo":"BNB","pair":"BNB/BTC","side":"buy","price":0.0008819,"quantity":8.94},"b":{"coinFrom":"BNB","coinTo":"ZIL","pair":"ZIL/BNB","side":"buy","price":0.00594,"quantity":0.8},"c":{"coinFrom":"ZIL","coinTo":"BTC","pair":"ZIL/BTC","side":"sell","price":0.00000525,"quantity":4534},"rate":0.21979633,"ts":1520682679007}';
  const t4 =
    '{"id":"BTC-ETH-OMG","a":{"coinFrom":"BTC","coinTo":"ETH","pair":"ETH/BTC","side":"buy","price":0.078203,"quantity":0.59},"b":{"coinFrom":"ETH","coinTo":"OMG","pair":"OMG/ETH","side":"buy","price":0.0196,"quantity":0.01},"c":{"coinFrom":"OMG","coinTo":"BTC","pair":"OMG/BTC","side":"sell","price":0.001534,"quantity":1.62},"rate":0.07967229,"ts":1520688553746}';
  const t5 =
    '{"id":"BTC-BNB-WABI","a":{"coinFrom":"BTC","coinTo":"BNB","pair":"BNB/BTC","side":"buy","price":0.0008758,"quantity":9.45},"b":{"coinFrom":"BNB","coinTo":"WABI","pair":"WABI/BNB","side":"buy","price":0.12955,"quantity":0.19},"c":{"coinFrom":"WABI","coinTo":"BTC","pair":"WABI/BTC","side":"sell","price":0.00011373,"quantity":688},"rate":123,"ts":1520688553746}';
  const t6 =
    '{"id":"ETH-BTC-PPT","a":{"coinFrom":"ETH","coinTo":"BTC","pair":"ETH/BTC","side":"sell","price":0.078001,"quantity":37.585},"b":{"coinFrom":"BTC","coinTo":"PPT","pair":"PPT/BTC","side":"buy","price":0.001782,"quantity":4.99},"c":{"coinFrom":"PPT","coinTo":"ETH","pair":"PPT/ETH","side":"sell","price":0.022907,"quantity":1.1},"rate":0.26761543,"ts":1520705623932}';
  const t7 =
    '{"id":"BTC-ETH-ICX","a":{"coinFrom":"BTC","coinTo":"ETH","pair":"ETH/BTC","side":"buy","price":0.079221,"quantity":0.19},"b":{"coinFrom":"ETH","coinTo":"ICX","pair":"ICX/ETH","side":"buy","price":0.003662,"quantity":70.9},"c":{"coinFrom":"ICX","coinTo":"BTC","pair":"ICX/BTC","side":"sell","price":0.0002903,"quantity":67.56},"rate":0.06642301,"ts":1520765253834}';
  const t8 =
